# -*- coding: utf-8 -*-
#
# doitlive documentation build configuration file.
#
...
latex_documents = [
  ('index', 'doitlive.tex', u'doitlive Documentation',
...
man_pages = [
    ('index', 'doitlive', u'doitlive Documentation',
     [u'Steven Loria'], 1)
]
...
texinfo_documents = [
  ('index', 'doitlive', u'doitlive Documentation',
   u'Steven Loria', 'doitlive', 'Because sometimes you need to do it live.',
   ''),
]
